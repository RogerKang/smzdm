        ...
        jClocksGMT: function( options ) 
        {
            ...
            return this.each(function()
            {
                ...
                if( options.analog )
                {
                    ...
                    // create hour hand
                    $("<div />", { class: "jcgmt-rotatingWrapper" }).append($("<img />", { class: "jcgmt-hour", src: options.imgpath + require( "../assets/scss/img/clock/jcgmt-" + options.skin + "-clock_hour.png") })).appendTo("#" + id + ' .jcgmt-clockHolder');
                    // create min hand
                    $("<div />", { class: "jcgmt-rotatingWrapper" }).append($("<img />", { class: "jcgmt-min", src: options.imgpath +require("../assets/scss/img/clock/jcgmt-" + options.skin + "-clock_min.png") })).appendTo("#" + id + ' .jcgmt-clockHolder');
                    // create sec hand
                    $("<div />", { class: "jcgmt-rotatingWrapper" }).append($("<img />", { class: "jcgmt-sec", src: options.imgpath +require("../assets/scss/img/clock/jcgmt-" + options.skin + "-clock_sec.png") })).appendTo("#" + id + ' .jcgmt-clockHolder');
                    // create clock face
                    $("<img />", { class: "jcgmt-clock", src: options.imgpath +require('../assets/scss/img/clock/jcgmt-' + options.skin + '-clock_face.png') }).appendTo("#" + id + ' .jcgmt-clockHolder');
                }
